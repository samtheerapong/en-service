...
/** @var backend\modules\docs\models\DocumentsSearch $searchModel */
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                return '<span class="badge" style="background-color:' . $model->categories->color . ';"><b>' . $model->categories->code . '</b></span>';
                            },
                            'filter' => Select2::widget([
                                'model' => $searchModel,
                                'attribute' => 'categories_id',
                                'data' => ArrayHelper::map(DocumentCategories::find()->all(), 'id', 'code'),
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                return '<span class="badge" style="background-color:' . $model->status->color . ';"><b>' . $model->status->code . '</b></span>';
                            },
                            'filter' => Select2::widget([
                                'model' => $searchModel,
                                'attribute' => 'status_id',
                                'data' => ArrayHelper::map(DocumentStatus::find()->all(), 'id', 'code'),
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                ...
                                $badgeColor = ($daysToExpiration < $model->days_left) ? '#FF1E00' : '#5BB318';
