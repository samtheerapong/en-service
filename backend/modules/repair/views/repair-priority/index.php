...
/** @var backend\modules\repair\models\RepairPrioritySearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = Yii::t('app', 'Repair Priority');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="repair-priority-index">
    <p>
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'urlCreator' => function ($action, RepairPriority $model, $key, $index, $column) {
